				...
				<div class="row clearfix">
					...
					<div class="col-xs-12 col-sm-6" align="right">
						...
						<a class="btn bg-teal" href="{{Request::URL()}}/edit" id="atoedit">
							...
							<a class="btn bg-red" href="#" id="deleteH2H" data-id="{{$serviceDetail->Form_Host_to_Host[0]->service_id}}">
						...
						<?php foreach ($serviceDetail->Form_Host_to_Host as $row): ?>
							<tr>
								...
								<?php else: ?>
									...
									<?php else: ?>
										<td align="center">
											<button url="h2h/finishTask/{{$row->id}}" class="btn bg-teal status btnFinishTask">

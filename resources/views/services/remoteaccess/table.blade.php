				...
				<div class="row clearfix">
					...
					<div class="col-xs-12 col-sm-6" align="right">
						...
						<?php endif ?>	
							...
							<a class="btn bg-red" href="#" id="deleteRemoteAccess" data-id="{{$serviceDetail->Form_Pendaftaran_Remote_Access[0]->service_id}}">
						...
						<?php foreach ($serviceDetail->Form_Pendaftaran_Remote_Access as $row): ?>
							<tr>
								...
								<?php else: ?>
									...
									<?php else: ?>
										<td align="center">
											<button url="remoteAccess/finishTask/{{$row->id}}" class="btn bg-teal status btnFinishTask">
